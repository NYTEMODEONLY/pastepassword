        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading || !password} style={{
              width: "100%", height: 44, borderRadius: 10,
              background: loading || !password ? "#4a2d6e" : "linear-gradient(180deg, #8F5CD4 0%, #6937A5 100%)",
              color: "#fff", fontSize: 14, fontWeight: 600,
              border: "none", cursor: loading || !password ? "not-allowed" : "pointer",
              opacity: loading || !password ? 0.5 : 1,
              boxShadow: loading || !password ? "none" : "0 1px 3px rgba(123,69,193,0.3), inset 0 1px 0 rgba(255,255,255,0.12)",
